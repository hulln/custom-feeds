...
LABELS = {
    "from": "Od", "od": "Od", "to": "Za", "za": "Za",
    "date": "Datum", "datum": "Datum", "poslano": "Datum", "sent": "Datum",
    "subject": "Zadeva", "zadeva": "Zadeva",
}
...
def main() -> None:
    ...
    feed = {
        ...
        "feed_url": "https://raw.githubusercontent.com/hulln/custom-feeds/main/slovlit/feed.json",
