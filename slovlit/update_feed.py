...
FEED_URL = "https://raw.githubusercontent.com/hulln/custom-feeds/main/slovlit/feed.xml"
SITE_URL = "https://mailman.ijs.si/pipermail/slovlit/"
ITEM_LIMIT = 30
USER_AGENT = "CustomFeeds-SlovLit/1.0 (+https://github.com/hulln/custom-feeds)"
...
def build_feed(items):
    ...
    for tag, text in [
        ...
        ("generator", "Custom Feeds – SlovLit"),
    ]:
